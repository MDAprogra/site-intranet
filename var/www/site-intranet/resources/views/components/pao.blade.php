    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-10 text-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-700">
                                ...
                                @foreach ($CompteDossierSemaine as $semaine => $nombre)
                                    ...
                                    @endphp
                                    <tr data-semaine="{{ $semaine }}" onclick="highlightWeek('{{ $semaine }}')"
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-700 table-auto border-collapse">
                                <thead class="bg-gray-700">
                                <tr>
                                ...
                                <tbody class="bg-gray-800 divide-y divide-gray-700 text-sm" id="resultTableBody">
                                @foreach ($EcartPAO as $pao)
                                    <tr data-semaine="{{ $pao->semaine }}" class="hover:bg-gray-700 cursor-pointer"
                                        ...
                                        <td colspan="8" class="p-4 hidden" id="details-{{ $loop->index }}">
                                            <div class="bg-gray-700 p-6 rounded-lg shadow-md">
                                                <h3 class="text-lg font-semibold text-gray-200 mb-4">
                                                    ...
                                                    dossier {{ $pao->opre_dossier }}
                                                </h3>
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <div>
                                                        <p class="text-sm text-gray-300">
                                                            <span
                                                                class="font-medium">Client:</span> {{ $pao->endv_cclient }}
                                                        </p>
                                                        <p class="text-sm text-gray-300">
                                                        ...
                                                        <p class="text-sm text-gray-300">
                                                            <span
                                                                class="font-medium">Salarié:</span> {{ $pao->opre_sal }}
                                                        </p>
                                                        <p class="text-sm text-gray-300">
                                                            <span
                                                                class="font-medium">Deviseur:</span> {{ $pao->endv_init_dev }}
                                                        </p>
                                                    </div>
                                                    <div>
                                                        <p class="text-sm text-gray-300">
                                                            <span
                                                                class="font-medium">Temps Prévu:</span> {{ $pao->tps_devis }}
                                                        </p>
                                                        <p class="text-sm text-gray-300">
                                                            <span
                                                                class="font-medium">Temps Réel:</span> {{ $pao->tps_reel }}
                                                        </p>
                                                        <p class="text-sm text-gray-300">
                                                            ...
                                                            @else
                                                                <span
                                                                    class="text-green-500">{{ $pao->ecart_tps }}</span>
                                                            @endif
                                                        </p>
                                                    </div>
                                                </div>
        ...
        function highlightWeek(week) {
            ...
            rows.forEach(row => {
                if (row.dataset.semaine === week) {
                    row.classList.add('bg-blue-300'); // Utilisation de bg-blue-300 pour un surlignage bleu clair
                } else {
