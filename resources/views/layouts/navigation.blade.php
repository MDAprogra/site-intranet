<nav x-data="{ open: false }" class="bg-gray-800 shadow-md py-4 px-6">
    <div class="max-w-7xl mx-auto flex justify-between items-center">
        <div class="flex items-center">
            ...
            <div class="hidden space-x-4 sm:flex">
                <x-nav-link :href="route('indicateur')" :active="request()->routeIs('indicateur')" class="text-gray-300 hover:text-white">
                    {{ __('Indicateurs') }}
                </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('indicateur')" :active="request()->routeIs('indicateur')" class="text-gray-300 hover:text-white">
                {{ __('Indicateurs') }}
            </x-responsive-nav-link>
            @if(Auth::user()->role == 'admin')
                <x-responsive-nav-link :href="route('utilisateur')" :active="request()->routeIs('utilisateur')" class="text-gray-300 hover:text-white">
                    {{ __('Utilisateur') }}
                </x-responsive-nav-link>
            @endif
        </div>
